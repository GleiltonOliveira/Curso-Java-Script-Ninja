...
*/
carro.adicionarPessoa = function(entrarCarro){
   var totalPessoas = carro.quantidadePessoas + entrarCarro;
   ...
   if(totalPessoas > carro.assentos){
      ...
      var sobraCarro = carro.assentos - carro.quantidadePessoas;
      var plural = sobraCarro === 1  ? "Pessoa" : "Pessoas";
       return console.log("Só cabem mais "+ sobraCarro + " " + plural);
       
   }
  
   carro.quantidadePessoas += entrarCarro;
...
carro.obterMarcaModelo(); //Esse carro é um Fiat Touro
